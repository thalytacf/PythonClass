...
print(f'Lista de {lista[0][0]} - {lista[1][1:7]} \nLista de {lista[0][1]} - {lista[2][1:7]} \nLista de {lista[0][2]} - {lista[3][1:8]}\n')

# print('2: imprima a lista verduras e mostre todos os seus elemantos')
print(f'Lista de {lista[0][1]} - {lista[2][1:7]}\n')
...
print(f'{lista[0][0]}: {lista[1][2]} e {lista[1][4]} - {lista[0][1]}: {lista[2][2]} e {lista[2][4]}\n{lista[1][2]}: {lista[3][1]}, {lista[3][4]} e {lista[3][5]} \n')
...
print(f'{lista[0][1]}: 5 maços de {lista[2][5]}, 4 pés de {lista[2][0]} e {lista[2][1]}, 2 cabeças de {lista[2][4]}\n')
# print('9: imprima com f-string a seguinte sequência: legumes: 1kg de feijão, 2kg de gão de bico, 1.5 kg dde soja,'
#       '1 pacote de ervilha')
print(f'{lista[0][2]}: 1kg de {lista[3][0]}, 2kg  de {lista[3][5]}, 1.5 kg {lista[3][6]}, 1 pacote de {lista[3][1]}\n')
# print('10: imprima a lista legumes e mostre todos os seus elemantos')
print(f'Lista de {lista[0][2]}: {lista[0:8]}')