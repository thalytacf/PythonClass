...
print(f'\n {lista[3] } é muito bom, sinto muito {lista[2]} quando eu chupo {lista[4]}')
...
print(f'\n{lista[5]} - {lista[3]} - {lista[0]} - {lista[6]} - {lista[1]} - {lista[4]}')
...
print(f'\n{lista[2]} - {lista[0]} - {lista[0]} - {lista[3]} - {lista[6]} - {lista[5]} - {lista[0]} - {lista[1]}\n ')
